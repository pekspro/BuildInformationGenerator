...
internal static class TestHelpers
{
    public static SettingsTask ScrubGeneratedCodeAttribute(this SettingsTask settings)
        => settings.ScrubLinesWithReplace(
            line => line.Replace($"""GeneratedCodeAttribute("Pekspro.BuildInformationGenerator", "{Constants.Version}")""",
                """GeneratedCodeAttribute("Pekspro.BuildInformationGenerator", "FIXED_VERSION")"""));
        ...
        where T : IIncrementalGenerator, new()
    {
        ...
        var references = AppDomain.CurrentDomain.GetAssemblies()
            ...
            .Concat(new[]
            {
                ...
                MetadataReference.CreateFromFile(typeof(BuildInformationAttribute).Assembly.Location)
            });
